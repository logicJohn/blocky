...
export class RegulatorComponent implements OnInit {
  ...
  regulatorOrginization = new FormControl('', Validators.required);
  ...
  constructor(public serviceRegulator: RegulatorService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      regulatorOrginization: this.regulatorOrginization
    });
  };
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.acme.pii.Regulator',
      'regulatorId': this.regulatorId.value,
      'regulatorName': this.regulatorName.value,
      'regulatorOrginization': this.regulatorOrginization.value
    };

    this.myForm.setValue({
      'regulatorId': null,
      'regulatorName': null,
      'regulatorOrginization': null
    });
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.regulatorOrginization) {
        formObject.regulatorOrginization = result.regulatorOrginization;
      } else {
        formObject.regulatorOrginization = null;
      }
